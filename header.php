...
<body <?php body_class(); ?>>
<?php StaticTemp\Tags\before_page(); ?>
<div id="page" class="site" itemscope="itemscope" itemtype="<?php StaticTemp\Tags\site_schema(); ?>">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'statictemp' ); ?></a>
	...
	<nav id="site-navigation" class="main-navigation" role="directory" itemscope itemtype="http://schema.org/SiteNavigationElement">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
			...
			<?php esc_html_e( 'Menu', 'statictemp' ); ?>
		</button>
		<?php
		wp_nav_menu( array(
			'theme_location' => 'main',
				...
				<figure>
					...
					if ( has_header_image() ) {
						...
						echo sprintf(
							...
							get_bloginfo( 'name' ) . __( 'header image', 'statictemp' )
						);
					} ?>
				</figure>
			</div>
